...
2024年MNDWI试导出已完成本地验证，并已派生水体掩膜和有效观测掩膜候选瓦片；这三个2024年资产标记为`processing`，其余32个图层年份资产保持`not_generated`。在资产发布并晋级为`ready`前，页面不会请求这些栅格瓦片，也不会回退到其他年份。完整契约与晋级流程见`docs/raster_tile_contract.md`。
